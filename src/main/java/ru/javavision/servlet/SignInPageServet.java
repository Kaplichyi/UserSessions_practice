        ...
        try {
            ...
            if(Login.length() > 3 || Password.length() > 3)
            {
                ...
                if (res != null) {
                    ...
                    User curruser = new User(res.getString("ID"), res.getString("Login"), res.getString("Password"), res.getString("Name"), res.getString("EMail"), res.getString("Gender"), res.getString("BDay"), res.getString("FavColor"), res.getString("Description"), res.getString("Mailing"), res.getString("UsrAgrmnt"));
